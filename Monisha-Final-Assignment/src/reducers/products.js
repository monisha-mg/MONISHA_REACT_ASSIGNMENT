import { GET_PRODUCTS, DELETE_PRODUCT, DELETE_PRODUCT_SUCCESS, ADD_INPUT_CHANGE, EDIT_PRODUCT, EDIT_INPUT_CHANGES, PAGINATE, MODAL_TOGGLE, PRODUCTS_LIST_SUCCESS, PRODUCTS_LIST_FAILURE } from "../action-types/products";
